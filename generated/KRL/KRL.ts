...
export class KRL__checkpointsResultValue0Struct extends ethereum.Tuple {
...
export class KRL extends ethereum.SmartContract {
  static bind(address: Address): KRL {
    return new KRL("KRL", address);
  }
  ...
  checkpoints(
    account: Address,
    pos: BigInt
  ): KRL__checkpointsResultValue0Struct {
    let result = super.call(
      "checkpoints",
    ...
    return changetype<KRL__checkpointsResultValue0Struct>(result[0].toTuple());
  }

  try_checkpoints(
    account: Address,
    pos: BigInt
  ): ethereum.CallResult<KRL__checkpointsResultValue0Struct> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):((uint32,uint224))",
      [
    ...
    return ethereum.CallResult.fromValue(
      changetype<KRL__checkpointsResultValue0Struct>(value[0].toTuple())
    );
  }
